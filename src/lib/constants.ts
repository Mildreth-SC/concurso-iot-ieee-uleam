...
export const PRIZE_PLACES = [
  ...
  },
  {
    ...
    rank: 2,
    accent: "silver",
    items: ["Certificado de excelencia", "Reconocimiento oficial", "Mención en ceremonia"],
  },
  {
    place: "3° lugar",
    rank: 3,
    accent: "bronze",
    items: ["Certificado de mérito", "Reconocimiento oficial", "Mención en ceremonia"],
  },
] as const;
...
export const BASES_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      "2° lugar: certificado de excelencia + reconocimiento oficial + mención en ceremonia.",
      "3° lugar: certificado de mérito + reconocimiento oficial + mención en ceremonia.",
...
export const SPONSOR_TIERS = [
  ...
  },
  {
    ...
    prizeAmount: "Premios en especie",
    prizePlace: "2° lugar",
    prizeNote: "Adjunta el valor del premio de 2° lugar por categoría",
    color: "silver",
    benefits: [
      "Financia los premios para el 2° lugar en una categoría",
  ...
  },
  {
    ...
    color: "cyan",
    benefits: [
      "Financia los premios para el 3° lugar en una categoría",
